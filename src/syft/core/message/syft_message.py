...
class SyftMessageProxy:
    ...
    and invokes the ffi functions in syft_core rust
    """
...
class SyftMessage(SyftMessageProxy):
    """
    This is a wrapper interface to SyftMessageProxy which allows a clean property accessor
    pattern using __getattr__ and some key mapping
    """
