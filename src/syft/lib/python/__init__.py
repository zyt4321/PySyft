...
def create_python_ast() -> Globals:
    ...
    methods = [
        ...
        ("syft.lib.python.Set.__and__", "syft.lib.python.Set", Set),
        ("syft.lib.python.Set.__contains__", "syft.lib.python.Bool", Bool),
        ("syft.lib.python.Set.__eq__", "syft.lib.python.Bool", Bool),
        ("syft.lib.python.Set.__ge__", "syft.lib.python.Bool", Bool),
        ("syft.lib.python.Set.__gt__", "syft.lib.python.Bool", Bool),
        ("syft.lib.python.Set.__iand__", "syft.lib.python.Set", Set),
        ("syft.lib.python.Set.__ior__", "syft.lib.python.Set", Set),
        ("syft.lib.python.Set.__isub__", "syft.lib.python.Set", Set),
        ("syft.lib.python.Set.__ixor__", "syft.lib.python.Set", Set),
        ("syft.lib.python.Set.__le__", "syft.lib.python.Bool", Bool),
        ("syft.lib.python.Set.__len__", "syft.lib.python.Int", Int),
        ("syft.lib.python.Set.__lt__", "syft.lib.python.Bool", Bool),
        ("syft.lib.python.Set.__ne__", "syft.lib.python.Bool", Bool),
        ("syft.lib.python.Set.__or__", "syft.lib.python.Set", Set),
        ("syft.lib.python.Set.__sub__", "syft.lib.python.Set", Set),
        ("syft.lib.python.Set.__xor__", "syft.lib.python.Set", Set),
        ("syft.lib.python.Set.add", "syft.lib.python._SyNone", _SyNone),
        ("syft.lib.python.Set.clear", "syft.lib.python._SyNone", _SyNone),
        ("syft.lib.python.Set.difference", "syft.lib.python.Set", Set),
        ("syft.lib.python.Set.difference_update", "syft.lib.python._SyNone", _SyNone),
        ("syft.lib.python.Set.discard", "syft.lib.python._SyNone", _SyNone),
        ("syft.lib.python.Set.intersection", "syft.lib.python.Set", Set),
        ("syft.lib.python.Set.intersection_update", "syft.lib.python._SyNone", _SyNone),
        ("syft.lib.python.Set.isdisjoint", "syft.lib.python.Bool", Bool),
        ("syft.lib.python.Set.issuperset", "syft.lib.python.Bool", Bool),
        ("syft.lib.python.Set.pop", "syft.lib.python._SyNone", _SyNone),
        ("syft.lib.python.Set.remove", "syft.lib.python._SyNone", _SyNone),
        (
